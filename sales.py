...
#====================================================================================================
df=pd.read_csv(r'C:\Users\ruaru\Desktop\CAPSTONE\retail sales\final_data.csv')
...
st.set_page_config(page_title= "Retail_Sales_Prediction | By ARUNRAJ R U",
                layout= "wide",
...
if selected == "HOME":
    ...
    with col2:
        col2.image(Image.open(r"C:\Users\ruaru\Desktop\CAPSTONE\retail sales\image.jpg"), width=700)   
...
if selected == "PREDICTION":
    ...
    if option == 'Prediction Process':
        ...
        with col10:
            ...
            import pickle
            model=pickle.load(open(r'C:\Users\ruaru\Desktop\CAPSTONE\retail sales\model.pkl', 'rb'))
...
if selected == "CONCLUSION":
    ...
    st.image(Image.open(r"C:\Users\ruaru\Desktop\CAPSTONE\retail sales\forecasting.jpg"), width=700)    
